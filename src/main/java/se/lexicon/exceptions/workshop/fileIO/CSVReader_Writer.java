...
public class CSVReader_Writer {
        ...
        try {
            ...
            if(reader!=null) {
                try {
                    ...
                    System.out.println("Problems trying to close the file.");
                }
            }
        }
        return names;
    ...
    public static void saveLastNames(List <String> lastNames) {
        ...
        try {
            ...
            System.out.println("An Error reading the file occurred" + e.getMessage());
        } finally {
            if (writer != null){
                try {
                    writer.close();
    ...
    public static void saveFemaleNames(List <String> femaleNames){
        ...
        try {
            ...
            System.out.println("An error occurred trying to write to the file. " + e.getMessage());
        } finally {
            if (writer != null){
                try {
                    writer.close();
                } catch (IOException e){
                    System.out.println("An error occurred trying to close the file" + e.getMessage());
                }
            }
        }
    ...
    public static void saveMaleNames(List <String> maleNames){
        ...
        try {
            ...
            System.out.println("An error occurred trying to save the male names " + e.toString());
        } finally {
            if (writer != null ){
                try {
                    writer.close();
                } catch (IOException e){
                    System.out.println("An error occurred trying to close the file. ");
                }
            }
        }
